...
test("It returns true when the search string is the same as the start of the models label", function () {
    var searchString = "search string 1";
...
test("It returns true when the search string is the same as the end of the models label", function () {
    var searchString = "search string 1";
...
test("It returns true when the search string is the same as the middle of the models label", function () {
    var searchString = "search string 1";
...
test("It returns true when the search string does not contain the models label", function () {
    var searchString = "search string 1";
